 ...
 * Manage WD instances
 */
public class WdManager extends ThucydidesWebDriverSupport {
    ...
    public static void set(final WebDriver driver) {
        ...
        wdm.set(driver);
        waitManager.set(new WebDriverWait(wdm.get(), 60));
        ajaxEle.set(new AjaxElementLocatorFactory(wdm.get(), 60));
    }
